...
jvm.Map.prototype = {
  ...
  setScale: function (scale, anchorX, anchorY, isCentered, animate) {
    var viewportChangeEvent = jvm.$.Event('zoom.jvectormap'),
      ...
      that = this,
      i = 0,
      count = Math.abs(Math.round((scale - this.scale) * 300 / Math.max(scale, this.scale))),
      scaleStart,
      scaleDiff,
      transXStart,
      transXDiff,
  ...
  /**
   * Set the map's viewport to the specific point and set zoom of the map to the specific level. Point and zoom level
   * could be defined in two ways: using the code of some region to focus on or a central point and zoom level as numbers.
   *
